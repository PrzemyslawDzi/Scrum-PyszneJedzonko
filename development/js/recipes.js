...
document.addEventListener('DOMContentLoaded', function() {
    ...
    let addNewRecipeButton = document.querySelector(".addNewRecipe");
    let addNewRecipeForm = document.querySelector(".addNewRecipeForm");
    ...
    saveAndCloseButton.addEventListener("click", function(){
        ...
        addNewRecipeButton.style.display = "block";
        addNewRecipeForm.style.display = "none";
    });

    addNewRecipeButton.addEventListener("click", function(){
        addNewRecipeButton.style.display = "none";
        addNewRecipeForm.style.display = "block";
    });
});